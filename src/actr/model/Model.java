	...
	public static void print(List<String> output, boolean construction, int nBack, boolean practice,
			int trialNum) { 
				...
				/*
							 ...
							 * FileWriter(
							 * "C:\\Users\\Held\\Documents\\GitHub\\scheunemann_task\\rehearsal\\data\\" + "
							 * data(1)_" + nBack + "-back_" + "_construction=" + construction + "
							 * _participant" + ServerMain.participantNumber + ".txt"); } else { writer = new
							 * FileWriter(
							 * "C:\\Users\\Held\\Documents\\GitHub\\scheunemann_task\\rehearsal\\data\\" + "
							 * data(2)_" + nBack + "-back_" + "_construction=" + construction + "
							 * _participant" + ServerMain.participantNumber + ".txt"); } for (String
							 * str:output) { writer.write(str); } writer.close(); }
							 * 
							 * 
